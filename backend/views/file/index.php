...
$(function () {
     ...
     $('#calendar').fullCalendar({
       ...
       header: {
         left: 'prev,next, today,createHoliday',
         center: 'title',
         right: 'listYear'
       },
       buttonText: {
      ...
      eventClick: function(event, element) {
		  ...
		  if(event.Allday == "1"){
			//โชว์รายละเอียดข้อมูลในโมเดล
	    	  ...
	    	  //$("#showTimeEnd").text((date_e._d).format('H\\:i'));//10:49 format
	    	...
	    	//กดปุ่มแก้ไขจะโชว์โมเดลขึ้นมา
	    	  $('#btnEdit').click(function(){
			    ...
			    //var check_type = event.typeID;
			    //var Type = $('#eventtype_edit option:selected').val();  
					       ...
					       <form action="" role="form" data-toggle="validator" id="validate"  method="post">
					        <div id="modalBody" class="modal-body">
								...
								<div class="form-group">
								  ...
								  <textarea class="form-control" rows="5" name="comment" value="" placeholder="รายละเอียด" id="description"></textarea>
								</div>
<!-- 					ปิดไว้ -->
...
<!-- 								</div> -->
					        ...
					        <div class="modal-footer">
					            <button type="button" class="btn btn-success" data-dismiss="modal" id="save">บันทึก</button>
					        	<button type="button" class="btn btn-danger" data-dismiss="modal">ยกเลิก</button>
				            </div>
				    </div>
				</div>
					      ...
					      <script type="text/javascript">
								    function ValidateExtension() {
								        ...
								        if (!regex.test(fileUpload.value.toLowerCase())) {
								            lblError.innerHTML = "กรุณาเลือกไฟล์: <b>" + allowedFiles.join(', ') + "</b> เท่านั้น";
								            return false;
								        }
								        lblError.innerHTML = "";
								        return true;
							   ...
							   <label class="col-xs-3 control-label">กรุณาเลือกไฟล์</label>
							    <div class="col-xs-7">
							    <input class="form-control" type="file" name="uploadfile" id="uploadfile">
						        </div>
							    <input type="submit" value="Upload" class="btn btn-success" name="submit" onclick="return ValidateExtension()">
							    <div align="center" >
