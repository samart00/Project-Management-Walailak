...
// $this->registerJsFile('@web/js/team/table-datatables-responsive.js', ['depends' => [\yii\web\JqueryAsset::className()]]);
    ...
    <div class="portlet light bordered myBox">
    												<div class="row">
    													<div class="form-group">
                                                            <label class="control-label col-md-3">ชื่องาน
                                                        ...
                                                        <br><br>
                                                         ...
                                                         <div class="row">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">สมาชิก</label>
                                                            <div class="panel" style="padding: 10px;">
																	<table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="member">
																			<thead>
																				<tr>
																					<th class="all"><input type="checkbox" name="checkAll"></th>
																					<th class="all">ชื่อผู้ใช้งานระบบ</th>
																			...
																			<tbody>
																				<?php 
																						...
																						foreach ($query->member as $field2):
																					?>
																					<tr>
																						<td class="checkbox-col" data-id="<?=$field2['userId']?>"><input type="checkbox"></td>
																						<td><span><?php echo User::getUserName((string)$field2['userId']) ?></span></td>
